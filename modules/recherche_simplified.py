...
def generate_simple_plainte(plaignants, mis_en_cause, infractions, type_plainte, contexte):
    """Génère une plainte de manière simplifiée"""
...
5. Préjudices subis
6. {"Constitution de partie civile et demandes" if "partie civile" in type_plainte else "Demandes"}
7. Liste des pièces

Rédige de manière complète et professionnelle."""
