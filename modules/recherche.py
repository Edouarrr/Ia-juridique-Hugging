...
try:
    ...
    # Import des modèles
    from models.dataclasses import Document, PieceSelectionnee, AnalyseJuridique, InfractionIdentifiee
    
    # Import de la configuration
    from config.app_config import InfractionAffaires, ANALYSIS_PROMPTS_AFFAIRES, LLMProvider, SearchMode
