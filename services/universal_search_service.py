"""Service de recherche universelle - Redirection vers managers"""

# Ce fichier redirige vers le bon emplacement
# Le code réel est dans managers/universal_search_service.py
...
# Import depuis le bon emplacement
try:
    ...
    # Si l'import échoue, créer des classes de base
...
# Réexporter tout pour assurer la compatibilité
__all__ = [
    'UniversalSearchService',
    'Document',
    'QueryAnalysis',
